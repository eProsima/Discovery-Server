...
server = subprocess.Popen([ds_command, "test_1_server.xml"])
client1 = subprocess.Popen([ds_command, "test_1_1.xml"])
client2 = subprocess.Popen([ds_command, "test_1_2.xml"])
...
check = subprocess.Popen([ds_command, "snapshots_1_client1.xml", "snapshots_1_client2.xml", "snapshots_1_server.xml"])
