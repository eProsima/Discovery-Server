...
server = subprocess.Popen([ds_command, "test_2_server.xml"])
client1 = subprocess.Popen([ds_command, "test_2_1.xml"])
client2 = subprocess.Popen([ds_command, "test_2_2.xml"])
...
check = subprocess.Popen([ds_command, "snapshots_2_client1.xml", "snapshots_2_client2.xml", "snapshots_2_server.xml"])
