...
xml_server_path = sys.argv[2]     # '\\...\\discovery-server\\resources\\xml\\test_09_WLP_server.xml'
xml_client_path = sys.argv[3]     # '\\...\\discovery-server\\resources\\xml\\test_09_WLP_client.xml'
