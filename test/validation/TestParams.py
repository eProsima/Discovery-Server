...
"""Script to load and work with test parameters."""
import logging
...
class TestParams(object):
    """
    Class to load the parameters for the tests.

    It loads the csv file with the tests parameters and
    encapsualte the methods to the variables.
    """
    ...
    def __init__(
        ...
        """
        Build a test parameters object.
