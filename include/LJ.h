...
namespace eprosima {
    namespace discovery_server {
        ...
        public:
            ...
            DPC(const std::chrono::steady_clock::time_point tp, fastrtps::ParticipantAttributes && atts, addPart m, DPD* pD = nullptr) 
                : _atts(std::move(atts)), _m(m), LJD(tp), _pD(pD) {}
            ~DPC() override {}
        ...
        public:
            ...
            DPD(const std::chrono::steady_clock::time_point tp, GUID_t & id)
                : _id(id), LJD(tp) {}
            ~DPD() override {}
        ...
        public:
            ...
            DED(const std::chrono::steady_clock::time_point tp, GUID_t & id = GUID_t::unknown())
                : _id(id), LJD(tp) {}
            ~DED() override {}
        ...
        void DEC<PS>::operator()(DSManager & man) /*override*/
        {
            ...
            else
            {
                ...
                {
                    types::DynamicPubSubType* pDt = man.setType(type_name);
